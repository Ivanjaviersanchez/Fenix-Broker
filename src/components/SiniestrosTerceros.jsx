  ...
  return (
    <div className="siniestros-container">
      ...
      <div className="siniestros-header">
        ...
        <h3>DE TERCEROS</h3>
        <p>
          En esta sección podés reclamar por los daños y/o lesiones que sufriste como consecuencia de un accidente con un vehículo asegurado en FENIX.
        </p>
      </div>
      ...
      <div className="siniestros-cards">
        ...
        <div className="siniestro-card">
          ...
          <div className="contact-icons">
            <div className="contact-icons">
              ...
              <a
                href="https://wa.me/5492235059018?text=URGENTE!!%20Necesito%20asistencia%20por%20un%20siniestro%20a%20Terceros"
                target="_blank"
        ...
        <div className="siniestro-card destacado">
          ...
          <p>
            Envíanos tus datos por E-mail o Whatsapp para poder iniciar tu denuncia.
          </p>
          <div className="contact-icons">
            <div className="contact-icons">
              <a
              ...
              <a
                href="https://wa.me/5492235059018?text=Hola!%20Necesito%20informar%20un%20siniestro%20a%20Terceros"
                target="_blank"
                rel="noopener noreferrer"
                className="contact-icon whatsapp"
                aria-label="WhatsApp"
        ...
        <div className="siniestro-card">
          ...
          <div className="contact-icons">
            ...
            <a
              href="https://wa.me/5492235059018?text=Hola!%20Necesito%20contactar%20con%20un%20asesor%20para%20informar%20un%20siniestro%20de%20Terceros"
              target="_blank"
              rel="noopener noreferrer"
              className="contact-icon whatsapp"
              aria-label="WhatsApp"
